...
namespace Store.Tests
{
    public class StoreManagerTests
    {
        ...
        [Test]
        public void ConstructorShouldWorkCorrectly() // pravilno rabotene na ctor
        {
        ...
        [Test]
        public void AddProductShouldWorkCorrectly() // pravilno rabotene na add method
        {
            StoreManager storeManager = new StoreManager();
        ...
        [Test]
        public void AddProductShouldThrowExceptionWhenProductIsNull() // throw na add product null
        {
            StoreManager storeManager = new StoreManager();
        ...
        [Test]
        public void AddShouldThrowExceptionWhenInvalidProductsQuantity() // throw na add za nevaliden produkt
        {
            StoreManager storeManager = new StoreManager();
